function build_ac_opf!(m::Model)
    ...
    gen_cost_lin = m.ext[:parameters][:gen][:cost] #EDITED BY AMANDA WEST 9/6/2024
    ...
    ##### OBJECTIVE FUNCTION
                #sum(sum(aw_gen_cost[g]*gen_p[g,t] #EDITED BY AMANADA WEST 9/6/2024
    print("Gen_cost_lin:",gen_cost_lin)
    print("Gen_cost_lin size:", size(gen_cost_lin))
    print("Gen_p:", gen_p[24,1])
